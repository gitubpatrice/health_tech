...
void main() {
  ...
  test('produces a valid ZIP with manifest, client, animals, sessions',
      () async {
    final now = DateTime.now();
    final c = await clients.create(Client(
      id: '',
      firstName: 'Alice',
      lastName: 'Martin',
    ...
    final sessionsJson = archive.files
        .firstWhere((f) => f.name == 'sessions.json')
        .content as List<int>;
